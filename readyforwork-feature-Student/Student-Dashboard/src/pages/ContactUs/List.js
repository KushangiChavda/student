...
const List = (props) => {
  ...
  const getListData = () => {
    api
      .get("/contactus")
      .then((res) => {
        let listData = res.data.contacts
  ...
  const updateStatus = (id, status) => {
    ...
    api
      .put(`/contactus/status/${id}/${status}`)
      .then((res) => {
  ...
  const recoverById = (id) => {
    ...
    api
      .put(`/contactus`, { _id: id, isDeleted: false })
      .then((res) => {
        dispatch(successAlert(res.data.message));
        return getListData();
      })
              ...
              <div className="row mb-2">
                ...
                <div className="col-sm-6">
                  <div className="text-sm-end">
                    ...
                    >
                      <i className="mdi mdi-plus me-1" /> New Inquiry
                    </Link>
                  </div>
                </div>
                {/* end col*/}
